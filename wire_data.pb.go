...
func (m *WireData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func skipWireData(dAtA []byte) (n int, err error) {
	...
	for iNdEx < l {
		...
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupWireData
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	...
	ErrUnexpectedEndOfGroupWireData = fmt.Errorf("proto: unexpected end of group")
)
