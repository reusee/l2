...
type WireData struct {
	...
	IP     []byte `protobuf:"bytes,3,opt,name=IP" json:"IP"`
}
...
var fileDescriptor_bd9a994a62fb525b = []byte{
	...
	0xd7, 0x07, 0x4b, 0x25, 0x95, 0xa6, 0x81, 0x79, 0x60, 0x0e, 0x98, 0x05, 0xd1, 0xa2, 0x14, 0xc6,
	...
	0x2a, 0x05, 0x15, 0x13, 0x12, 0xe1, 0x62, 0xf2, 0x0c, 0x90, 0x60, 0x46, 0xd2, 0xc4, 0xe4, 0x19,
	0xe0, 0x24, 0x71, 0xe2, 0x91, 0x1c, 0xe3, 0x85, 0x47, 0x72, 0x8c, 0x0f, 0x1e, 0xc9, 0x31, 0x4e,
	0x78, 0x2c, 0xc7, 0x70, 0xe1, 0xb1, 0x1c, 0xc3, 0x8d, 0xc7, 0x72, 0x0c, 0x80, 0x00, 0x00, 0x00,
	0xff, 0xff, 0x14, 0x37, 0x24, 0x8e, 0xb6, 0x00, 0x00, 0x00,
}
...
func (m *WireData) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IP != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintWireData(dAtA, i, uint64(len(m.IP)))
		i += copy(dAtA[i:], m.IP)
	}
	return i, nil
}
